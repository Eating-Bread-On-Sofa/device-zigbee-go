...
WORKDIR $GOPATH/src/github.com/edgexfoundry/device-zigbee-go
...
COPY --from=builder /go/src/github.com/edgexfoundry/device-zigbee-go/cmd /

ENTRYPOINT ["/device-zigbee-go","--profile=docker","--confdir=/res","--registry=consul://edgex-core-consul:8500"]
